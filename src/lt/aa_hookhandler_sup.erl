...
init([]) ->
	...
	AAGroupChatSupA ={aa_super_group_chat_sup,{aa_super_group_chat_sup, start_link,[]},temporary,brutal_kill, supervisor, [aa_super_group_chat_sup] },
	AASysnSend = {sysn_send_sup,{sysn_send_sup, start_link,[]},temporary,brutal_kill, supervisor, [sysn_send_sup] },
%%	AABlacklist ={ aa_blacklist,{aa_blacklist, start_link, []}, permanent, brutal_kill, worker, [aa_blacklist] },
    	{ok, {{one_for_one, 5, 10}, [AAHookhandler,AAGroupChatSup,AAGroupChatSupA,AASysnSend,AALog,AAOfflineMod]}}.
%%%===================================================================
%%% Internal functions
%%%===================================================================
