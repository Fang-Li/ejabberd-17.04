-module(aa_super_group_chat_sup).
...
init([]) ->
	AAClild = {aa_super_group_chat, {aa_super_group_chat,start_link,[]}, temporary, 2000, worker, [aa_super_group_chat] },
	?DEBUG("###### aa_group_chat_sup ::::> ~p",[started]),
    	{ok,{{simple_one_for_one,0,1}, [AAClild]}}.
